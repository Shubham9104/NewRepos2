...
namespace GroceryManagement.web.Areas.User1.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,CustomerName,CustomerAddress,MobileNumber,Email")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,CustomerName,CustomerAddress,MobileNumber,Email")] Customer customer)
        {
